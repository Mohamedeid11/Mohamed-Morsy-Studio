...
@section('content')
    <div class="text-center">
        <a href="index.html">
            <span><img src="../../AdminLTE/Images/white copy.png" alt="" height="60"></span>
        </a>
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group mb-0 text-center">
                    ...
                    @if (Route::has('password.request'))
                        <a class="btn btn-link font-weight-bolder  mt-3" style="color: red" href="{{ route('password.request') }}">
                            <i class="fa fa-lock mr-1"></i> {{ __('Forgot Your Password?') }}

                        </a>
                        <p style="color: black">Don't have an account? <a href="{{ route('register') }}" class="text-dark ml-1"><b style="color: gold">{{ __('Register') }}</b></a></p>
                        </a>
                    @endif
                </div>
